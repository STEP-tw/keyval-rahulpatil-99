...
const contains=function(list,key,option) {
...
var StrictParseInfo=function(initialParsingFunction,validKeys,option) {
...
StrictParseInfo.prototype.pushKeyValuePair=function() {
  if(!contains(this.validKeys,this.currentKey,this.option))
